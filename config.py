...
IMAGE_DIR = os.path.join(RAW_DATA_DIR, "images")  # This exists
IMAGES_DIR = IMAGE_DIR  # Add alias for compatibility
DOCUMENT_FOLDER = os.path.join(BASE_DIR, "sample_docs")
...
# Vector Dimensions
# -----------------------------
TEXT_VECTOR_SIZE = 768  # all-mpnet-base-v2
...
# -----------------------------
TEST_SET_PATH = os.path.join(RAW_DATA_DIR, "test_set.jsonl")
RESULTS_DIR = os.path.join(DATA_DIR, "results")
os.makedirs(RESULTS_DIR, exist_ok=True)

# Add to config.py
TABLE_COLLECTION = "table_collection"
TABLE_VECTOR_SIZE = 768  # Same as text, but could use different model